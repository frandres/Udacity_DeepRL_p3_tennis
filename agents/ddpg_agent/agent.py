...
class Agent():
    ...
    def learn(self):
        ...
        # critic_loss = (F.mse_loss(critic_output, critic_estimated_values,reduce=False)*bias_correction).mean()
        # -----------------------
        ...
        # actor_loss = (-self.critic_local(states, actions_pred)*bias_correction).mean()
